...
@OnlyIn(Dist.CLIENT)
public class JoltProjectileRenderer extends EntityRenderer<JoltProjectileEntity> {
    ...
    public JoltProjectileRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }

    protected int getBlockLight(JoltProjectileEntity entityIn, float partialTicks) {
        return 15;
    }

    public void render(JoltProjectileEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        matrixStackIn.push();
     ...
     */
    public ResourceLocation getEntityTexture(JoltProjectileEntity entity) {
        return TEXTURE;
    }
}
