...
@OnlyIn(Dist.CLIENT)
public class AeroblastProjectileRenderer extends EntityRenderer<AeroblastProjectileEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("voxelmagica","textures/entity/spells/aeroblastprojectile.png");
    private static final RenderType type = RenderType.getEntityCutoutNoCull(TEXTURE);

    public AeroblastProjectileRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }

    protected int getBlockLight(AeroblastProjectileEntity entityIn, float partialTicks) {
        return 15;
    }

    public void render(AeroblastProjectileEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        matrixStackIn.push();
     ...
     */
    public ResourceLocation getEntityTexture(AeroblastProjectileEntity entity) {
        return TEXTURE;
    }
}
