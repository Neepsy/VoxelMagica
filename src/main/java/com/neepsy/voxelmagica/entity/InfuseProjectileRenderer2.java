...
@OnlyIn(Dist.CLIENT)
public class InfuseProjectileRenderer2 extends EntityRenderer<InfuseProjectileEntity> {
    ...
    public InfuseProjectileRenderer2(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }

    protected int getBlockLight(InfuseProjectileEntity entityIn, float partialTicks) {
        return 15;
    }
